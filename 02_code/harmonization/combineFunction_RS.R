...
combine_datasets <- function(baseline_path, endline_path, id_column = "surveyID", dictionary_path, ttmAssign_path, combine_type = "long") {
  ...
  # CAMBIO DE ORDEN CAMBIO DE ORDEN CAMBIO DE ORDEN CAMBIO DE ORDEN CAMBIO DE ORDEN CAMBIO DE ORDEN CAMBIO DE ORDEN 
  # EDICIÓN EDICIÓN EDICIÓN EDICIÓN EDICIÓN EDICIÓN EDICIÓN EDICIÓN EDICIÓN EDICIÓN EDICIÓN EDICIÓN EDICIÓN EDICIÓN
