...
library(tidyverse); library(dplyr); library(readxl); library(purrr); library(tidyr); library(stringr)
...
source("combineFunction_RS.R")
source("graphFunctions_RS.R")
source("regressionFunctions_RS.R")
